  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold text-stone-900">Promo codes</h1>
      ...
      <div className="rounded-2xl border border-amber-200/60 bg-white shadow-sm">
        <table className="w-full text-left text-sm">
          <thead className="border-b border-amber-200/60 bg-amber-50/40">
            <tr>
              <th className="px-4 py-3 font-semibold text-stone-700">Code</th>
              <th className="px-4 py-3 font-semibold text-stone-700">Campaign</th>
              <th className="px-4 py-3 font-semibold text-stone-700">
                Discount
              </th>
              <th className="px-4 py-3 font-semibold text-stone-700">Redeemed</th>
          ...
          <tbody>
            {promoCodes.length ? (
              promoCodes.map((promo) => (
                <tr key={promo.id} className="border-b border-amber-100">
