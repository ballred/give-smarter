...
Status: in progress
Notes: Admin auction list + create flow + CRUD endpoints and bid increment helpers; public catalog + bid form added; buy-now checkout and outbid message queueing added.
