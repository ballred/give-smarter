...
Status: in progress
Notes: Admin ticketing list + create form and CRUD API routes added; add-ons management, seating tables admin + auto seat generation + attendee table assignments added; public ticket checkout supports add-ons and promo codes.
