...
Status: in progress
Notes: Admin auction list + create flow + CRUD endpoints and bid increment helpers; public catalog + bid form added.
...
Status: in progress
Notes: Admin shells + CRUD endpoints for raffles, contests, store products, candidates, variants, and draws; public store + raffle checkout flows added.
