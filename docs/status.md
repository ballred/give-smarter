...
Status: in progress
Notes: Admin auction list + create flow + CRUD endpoints and bid increment helpers; public catalog + bid form added; buy-now checkout, proxy bidding logic, watchlist signup + bid alerts, and outbid message queueing added.
